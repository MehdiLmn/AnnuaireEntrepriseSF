...
class User implements UserInterface, PasswordAuthenticatedUserInterface
{
    ...
    private ?string $face_picture = null;
    ...
    public function setFacePicture(?string $face_picture): static
    {
        $this->face_picture = $face_picture;
    ...
    public function setRealiseDate(\DateTimeInterface $realise_date): static
    {
